        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="form-options">
              ...
              <Link to="/forgot-password" className="forgot-password" data-testid="login-forgot-password">
                Esqueceu a senha?
              </Link>
            </div>
          ...
          <div className="auth-footer">
            <p>
              Não tem uma conta? <Link to="/signup" data-testid="login-signup">Cadastre-se</Link>
            </p>
          </div>
        </div>

        <div className="auth-image">
          <img src="/placeholder.svg?height=600&width=500" alt="Tattoo art" data-testid="login-image" />
